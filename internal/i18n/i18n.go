...
var Translations = map[string]map[string]string{
	...
	"Türkçe": {
		...
		"Failed to fetch recipes":                                                                           "Tarifler getirilemedi",
		"Invalid recipe ID":                                                                                 "Geçersiz tarif ID",
		"Recipe not found":                                                                                  "Tarif bulunamadı",
		"Failed to fetch recipe":                                                                            "Tarif getirilemedi",
		"Failed to create recipe":                                                                           "Tarif oluşturulamadı",
		"Failed to update recipe":                                                                           "Tarif güncellenemedi",
		"Recipe updated successfully":                                                                       "Tarif başarıyla güncellendi",
		"Failed to delete recipe":                                                                           "Tarif silinemedi",
		"Recipe deleted successfully":                                                                       "Tarif başarıyla silindi",
		"Failed to cook recipe":                                                                             "Tarif pişirilemedi",
		"Insufficient stock for recipe ingredients":                                                         "Tarif malzemeleri için yetersiz stok",
		"Recipe cooked successfully":                                                                        "Tarif başarıyla pişirildi",
		"Failed to add recipe to shopping list":                                                             "Tarif alışveriş listesine eklenemedi",
		"Recipe ingredients added to shopping list successfully":                                            "Tarif malzemeleri alışveriş listesine başarıyla eklendi",
	},
}
