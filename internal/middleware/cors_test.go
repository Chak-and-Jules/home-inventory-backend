...
func checkCORSHeaders(t *testing.T, w *httptest.ResponseRecorder) {
	...
	expectedHeaders := map[string]string{
		...
		"Access-Control-Allow-Headers": "Content-Type, Content-Length, Accept-Encoding, X-CSRF-Token, Authorization, accept, origin, Cache-Control, X-Requested-With, x-home-id",
